...
@section('back-link', url('/scanner/putaway/' . $task->id ))

@section('content')
    <div class="col-12">
        <form action="{{url('/scanner/putaway/' . $task->id . '/finish' )}}">
            @csrf
            ...
            <div class="card mb-2">
                <div class="card-body d-flex w-100 justify-content-between">
                    ...
                    <div>
                        <strong>{{$task->destination->name ?? __('Bulk location')}}</strong>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-2">
                <div class="card-body d-flex w-100 justify-content-between">
                    ...
                    <div>
                        <strong>{{$task->destination->name ?? 'Bulk location'}}</strong>
                    </div>
                </div>
                <div class="card-body">
